...
const AllNetwork = ({ handleClickOpen }) => (
  <div>
    <Row className="video">
      ...
      <Col className="video-details" xs={ 12 }>
        <Col className="feature-media" xs={ 2 }>
          <a href="" className="big">
            <i className="icon icon-fb-circle-icon" />
          </a>
        </Col>
        <Col className="social-media p-10" xs={ 8 }>
        ...
        <Col className="dots p-0" xs={ 2 } onClick={ handleClickOpen }>
